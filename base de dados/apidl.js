...
function musically(URL) {
	return new Promise((resolve, rejecet) => {
        ...
        axios.request({
            ...
            const result = {
				thumbVideo: ch('body > div.welcome.section > div > div:nth-child(2) > div.col.s12.l4.center-align > div > div > img').attr('src'),
				usuario: ch('body > div.welcome.section > div > div:nth-child(2) > div.col.s12.l4.center-align > div > h2:nth-child(2) > b').text(),
				legenda: ch('body > div.welcome.section > div > div:nth-child(2) > div.col.s12.l4.center-align > div > h2:nth-child(3)').text(),
				VideoSemMarca: ch('body > div.welcome.section > div > div:nth-child(2) > div.col.s12.l8 > a:nth-child(3)').attr('href'),
				videoSemMarca2: ch('body > div.welcome.section > div > div:nth-child(2) > div.col.s12.l8 > a:nth-child(5)').attr('href'),
                videoEmHD: ch('body > div.welcome.section > div > div:nth-child(2) > div.col.s12.l8 > a:nth-child(7)').attr('href'),
				VideoComMarca: ch('body > div.welcome.section > div > div:nth-child(2) > div.col.s12.l8 > a:nth-child(9)').attr('href'),
